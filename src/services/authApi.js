...
const api = axios.create({
  baseURL: "https://backend-demo-esqk.onrender.com/", // Change if your backend runs elsewhere
  headers: {
...
export const vendorSignup = async (formData) => {
  try {
    const response = await axios.post(
      "https://backend-demo-esqk.onrender.com/signup/vendor/",
      formData,
      {
        headers: {
...
export const trainerSignup = async (formData) => {
  ...
  try {
    const response = await axios.post(
      "https://backend-demo-esqk.onrender.com/signup/trainer/",
      formData,
    );
    console.log(response);
    return response.data;
...
const BASE_URL = 'https://backend-demo-esqk.onrender.com/'; // Django backend URL
